...
const commandErrorKeys = {
  ...
  PROJECT_DATABASE_NOT_FOUND: 'errors.projectDatabaseNotFound',
  INVALID_PROJECT_DATABASE: 'errors.invalidProjectDatabase',
  PROJECT_DATABASE_ALREADY_EXISTS: 'errors.projectDatabaseAlreadyExists',
  PROJECT_DATABASE_VERSION_UNSUPPORTED: 'errors.projectDatabaseVersionUnsupported',
